...
@property(nonatomic) NSMutableArray *connectPeripherals;
@property(nonatomic) NSMutableArray *servicesThatNeedDiscovered;
@property(nonatomic) NSMutableArray *characteristicsThatNeedDiscovered;
@property(nonatomic) LogLevel logLevel;
@property(nonatomic, strong) NSMutableDictionary *rssiResults;
@property(nonatomic, strong) CBPeripheral *peripheral;
@property(nonatomic, strong) FlutterMethodCall *scanCall;
...
- (NSMutableArray *)connectPeripherals{
    if(!_connectPeripherals){
        _connectPeripherals = [NSMutableArray array];
    }
    return _connectPeripherals;
}
...
- (void)startScan{
    ...
    FlutterStandardTypedData *data = [_scanCall arguments];
...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
    if ([@"setLogLevel" isEqualToString:call.method]) {
        ...
        @try {
            _peripheral = [_scannedPeripherals objectForKey:remoteId];
            if(_peripheral == nil) {
            ...
            [self.connectPeripherals addObject:_peripheral];
            result(nil);
...
- (void)centralManager:(CBCentralManager *)central didDiscoverPeripheral:(CBPeripheral *)peripheral advertisementData:(NSDictionary<NSString *,id> *)advertisementData RSSI:(NSNumber *)RSSI {
    ...
    if (advertisementData[@"kCBAdvDataServiceUUIDs"]) {
        ...
        if (uuidArray.firstObject && ![self.uuids containsObject:uuidArray.firstObject]) {
            [self.uuids addObject:uuidArray.firstObject];
        }
    }
